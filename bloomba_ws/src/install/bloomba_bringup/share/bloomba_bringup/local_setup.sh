...
: ${AMENT_CURRENT_PREFIX:="/home/zhanger/tmp/bloomba/bloomba_ws/src/install/bloomba_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bloomba_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bloomba_bringup/environment/path.sh"
